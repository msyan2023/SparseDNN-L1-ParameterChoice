...
def Training(NN_width, TrainData, TrainLabel, TestData, TestLabel, lambd_dict, CheckStop, Exp, num_epoch=50000):
    ...
    history = {'TrainMSE': [], 'TestMSE': [], 'NNZ': [], 'lambd_dict': lambd_dict}
